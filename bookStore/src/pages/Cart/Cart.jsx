                ...
                <div className="table-responsive mb-4">
                    ...
                    <tbody className="border-0">
                        ...
                        <th className="ps-0 py-3 border-0" scope="row">
                            <div className="d-flex align-items-center"><a className="reset-anchor d-block animsition-link" href="detail.html"><img src="img/product-detail-2.jpg" alt="..." width="70"/></a>
                        ...
                        <td className="p-3 align-middle border-0"><a className="reset-anchor" href="#!"><i className="fas fa-trash-alt small text-danger"></i></a></td>
                        </tr>
                    </tbody>
                    </table>
                </div>
                ...
                <div className="card border-0 rounded-0 p-lg-4 bg-light">
                    ...
                    <ul className="list-unstyled mb-0">
                        ...
                        <form action="#">
                            ...
                            <input className="form-control" type="text" placeholder="Enter your coupon" onChange={()=>{}}/>
